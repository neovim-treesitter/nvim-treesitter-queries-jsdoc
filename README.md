# nvim-treesitter-queries-jsdoc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-jsdoc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-jsdoc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **jsdoc**, part of the
...
- [ ] Changes are scoped to `jsdoc` — do not include files for other languages
